...
// Bounce friction (src.0 = no friction, 0.0 = maximum friction)
...
typedef struct {
    ...
    float life;      // Life of particle (src.0 = newborn, < 0.0 = dead)
...
//========================================================================
// Draw all active particles. We use OpenGL src.src vertex
...
static void draw_particles(GLFWwindow* window, double t, float dt)
{
    ...
    // (-src,-src,0), and the lower right corner, PARTICLE_SIZE/2 * (src,-src,0).
...
static void setup_lights(void)
{
    ...
    // Set light source src parameters
