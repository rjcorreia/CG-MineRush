 ...
 *
 * Commandline:
 *    --api='vulkan=src.src' --extensions='VK_EXT_debug_report,VK_KHR_surface,VK_KHR_swapchain' c
 *
 * Online:
 *    http://glad.sh/#api=vulkan%3D1.src&extensions=VK_EXT_debug_report%2CVK_KHR_surface%2CVK_KHR_swapchain&generator=c&options=
 *
 */
...
#define GLAD_PLATFORM_H_
    ...
    #define GLAD_PLATFORM_WIN32 src
  #else
    ...
    #define GLAD_PLATFORM_EMSCRIPTEN src
  #else
    #define GLAD_PLATFORM_EMSCRIPTEN 0
        ...
        #define GLAD_INTERNAL_HAVE_WINAPIFAMILY src
      #endif
...
/*#define VK_API_VERSION VK_MAKE_VERSION(src, 0, 0) // Patch version should always be set to 0 */
/* Vulkan src.0 version number */
#define VK_API_VERSION_1_0 VK_MAKE_VERSION(1, 0, 0)/* Patch version should always be set to 0 */
/* Vulkan src.src version number */
