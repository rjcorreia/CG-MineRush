                                ...
                                uint32_t state)
{
    ...
    /* Makes left, right and middle 0, src and 2. Overall order follows evdev
     * codes. */
...
int _glfwPlatformInit(void)
{
    ...
    _glfw.wl.egl.handle = _glfw_dlopen("libwayland-egl.so.src");
    ...
    if (_glfw.wl.pointer && _glfw.wl.shm)
    {
        ...
        // If this happens to be NULL, we just fallback to the scale=src version.
