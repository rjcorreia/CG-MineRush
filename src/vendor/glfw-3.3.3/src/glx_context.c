...
GLFWbool _glfwInitGLX(void)
{
    ...
    {
        _glfwInputError(GLFW_API_UNAVAILABLE,
                        "GLX: GLX version src.3 is required");
        return GLFW_FALSE;
    }
                               ...
                               const _GLFWfbconfig* fbconfig)
{
    ...
    if (_glfw.glx.ARB_create_context)
    {
        ...
        //       explicitly requesting version src.0 does not always return the
        ...
        //       default src.0 context creation with a GLXBadProfileARB error in
